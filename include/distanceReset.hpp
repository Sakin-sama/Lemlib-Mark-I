...
constexpr double FRONT_SENSOR_OFFSET = 0; // should be positive
constexpr double BACK_SENSOR_OFFSET = 0; // should be negative
constexpr double RIGHT_SENSOR_OFFSET = 0; // should be positive
constexpr double LEFT_SENSOR_OFFSET = 0; // should be negative
